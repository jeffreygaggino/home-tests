...
const HeaderNav = {
    ...
    <div id="header-container" v-if="screen_width < 991" class="mobile-nav" :class="transparent_nav && 'transparent_nav'">
        <i class="icon-burger" >
    ...
    <div id="header-container" v-else class="desktop-nav" :class="transparent_nav && 'transparent_nav'">
